...
if ($_GET['alert'] == berhasil) {
    ...
    swal({
        title: "Berhasil",
        text: "Berhasil menambahkan isi Pelanggaran",
        type: "success",
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-book"></i><i class="gi gi-plus"></i>Tambah Isi Pelanggaran ( <?php echo $jenis_tatib; ?> )<br><small>SMK TELEKOMUNIKASI TELESANDI BEKASI</small>
            </h1>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Tambah</strong> Isi Pelanggaran ( <?php echo $jenis_tatib; ?> )</h2>
                </div>
                <!-- END Horizontal Form Title -->

                <!-- Horizontal Form Content -->
                <form action="proses/add_isi_pelanggaran.php" method="post" class="form-horizontal form-bordered">
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="example-hf-email">Nama Jenis Pelanggaran</label>
                        <div class="col-md-9">
                            <input type="text" name="jenis_tatib" class="form-control" value="<?php echo $jenis_tatib; ?>" required="" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="example-hf-email"> Isi </label>
                        <div class="col-md-9">
                            <textarea class="form-control" name="isi_pelanggaran" required=""></textarea>
                        </div>
                    </div>
