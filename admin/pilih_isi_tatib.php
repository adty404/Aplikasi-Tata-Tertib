...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-book"></i>Pilih Jenis Tata Tertib<br><small>SMK TELEKOMUNIKASI TELESANDI BEKASI</small>
            </h1>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><strong>Pilih</strong> Jenis Tata Tertib</h2>
                </div>
                <!-- END Select Components Title -->

                <!-- Select Components Content -->
                <form action="isi_tatib.php" method="post" class="form-horizontal form-bordered">
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="example-chosen">Jenis Tata Tertib</label>
                        <div class="col-md-6">
