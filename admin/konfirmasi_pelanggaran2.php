...
<div id="page-content">
    ...
    <div class="block full">
        ...
        <h2 style="text-align: center; font-family: Arial; margin-bottom: 30px;">Sedang Ditindaklanjuti</h2>
        ...
        <div class="table-responsive">
            <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                 <?php
                 $no = 0;
                 while ($show = mysqli_fetch_array($exe_laporan_pelanggaran2)){
                    $no++;
                    ?>
                    <tr>
                        ...
                        <?php 
                        if ($show['status2'] == 'Sudah Dikonfirmasi') {
                            ?>
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="proses/kasus_selesai.php?no_pelanggaran=<?php echo $show['no_pelanggaran']; ?>" data-toggle="tooltip" title="Kasus selesai" class="btn btn-xs btn-default"><i class="fa fa-check"></i></a>
                                <a href="proses/kasus_ditolak.php?no_pelanggaran=<?php echo $show['no_pelanggaran']; ?>" data-toggle="tooltip" title="Kasus ditolak" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                            </div>
                        </td>
                            <?php
                        }else if($show['status2'] == 'Belum Dikonfirmasi'){
                        ?>
                        <td class="text-center">
                            <div class="btn-group">
