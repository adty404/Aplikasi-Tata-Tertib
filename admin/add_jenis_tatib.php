...
if ($_GET['alert'] == berhasil) {
    ...
    function(isConfirm){
        if (isConfirm) {
            window.location = "add_jenis_tatib.php";
        }
    });
    </script>';
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-book"></i><i class="gi gi-plus"></i>Tambah Jenis Tata Tertib<br><small>SMK TELEKOMUNIKASI TELESANDI BEKASI</small>
            </h1>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Tambah</strong> Jenis Tata Tertib</h2>
                </div>
                <!-- END Horizontal Form Title -->

                <!-- Horizontal Form Content -->
                <form action="proses/add_jenis_tatib.php" method="post" class="form-horizontal form-bordered">
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="example-hf-email">Nama Jenis Tata Tertib</label>
                        <div class="col-md-9">
                            <input type="text" name="nama_tatib" class="form-control" placeholder="Masukan Nama Jenis Tata Tertib" required="">
