...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="fa fa-group"></i>Semua Data Siswa-Siswi<br><small>SMK TELEKOMUNIKASI TELESANDI BEKASI</small>
            </h1>
        </div>
    </div>
                 ...
                 while ($show = mysqli_fetch_array($exe_siswa)){
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="edit_data_siswa.php?nis=<?php echo $show['nis']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                <a href="proses/delete_data_siswa.php?nis=<?php echo $show['nis']; ?>" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php } ?>
