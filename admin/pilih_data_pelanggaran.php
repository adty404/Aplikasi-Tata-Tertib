...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-book"></i>Pilih Data Pelanggaran<br><small>SMK TELEKOMUNIKASI TELESANDI BEKASI</small>
            </h1>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><strong>Pilih</strong> Pilih Data Pelanggaran</h2>
                </div>
                <!-- END Select Components Title -->

                <!-- Select Components Content -->
                <form action="isi_data_pelanggaran.php" method="post" class="form-horizontal form-bordered">
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="example-chosen">Data Pelanggaran</label>
                        <div class="col-md-6">
