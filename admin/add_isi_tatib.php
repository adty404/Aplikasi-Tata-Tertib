...
if ($_GET['alert'] == berhasil) {
    ...
    swal({
        title: "Berhasil",
        text: "Berhasil menambahkan isi tata tertib",
        type: "success",
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-book"></i><i class="gi gi-plus"></i>Tambah Isi Tata Tertib ( <?php echo $jenis_tatib; ?> )<br><small>SMK TELEKOMUNIKASI TELESANDI BEKASI</small>
            </h1>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Tambah</strong> Isi Tata Tertib ( <?php echo $jenis_tatib; ?> )</h2>
                </div>
                <!-- END Horizontal Form Title -->

                <!-- Horizontal Form Content -->
                <form action="proses/add_isi_tatib.php" method="post" class="form-horizontal form-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="isi_tatib" required=""></textarea>
                        </div>
                    </div>
