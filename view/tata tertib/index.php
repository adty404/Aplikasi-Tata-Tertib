        ...
        <div class="page-sidebar sidebar horizontal-bar">
            <div class="page-sidebar-inner">
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink active open"><a href="index.php"><span class="menu-icon icon-grid"></span><p>Tata Tertib</p><span class="arrow"></span></a>
                    </li>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            <div class="panel-heading clearfix">
                                <h4 class="panel-title">Jenis Tata Tertib</h4>
                            </div>
                               ...
                               <div class="table-responsive">
                                <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 0;
                                        while ($show    =   mysqli_fetch_array($exe_tatib)){
                                            $no++;
                                            ?>
                                            <tr>
                                                <td style="text-align: center;"><?php echo $no; ?></td>
                                                <td><?php echo $show['nama_tatib']; ?></td>
                                                <td align="center"><a href="isi_tatib.php?jenis_tatib=<?php echo $show['nama_tatib']; ?>">SELENGKAPNYA</a></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
